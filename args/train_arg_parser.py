...
class TrainArgParser(BaseArgParser):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--epochs_per_hem_reset', type=int, default=5,
                                 help='Number of epochs between resetting the hard example miner distribution.')
        self.parser.add_argument('--learning_rate', type=float, default=1e-3,
                                 help='Initial learning rate.')
        self.parser.add_argument('--lr_scheduler', type=str, default='cosine_with_warmup',
                                 choices=('step', 'multi_step', 'plateau', 'cosine', 'cosine_warmup'),
        ...
        self.parser.add_argument('--lr_decay_step', type=int, default=25,
                                 help='Number of epochs (iters) between each multiply-by-gamma step.')
        self.parser.add_argument('--lr_warmup_steps', type=int, default=1e4,
                                 help='Number of epochs (iters) for the warmup period.')
        self.parser.add_argument('--lr_milestones', type=str, default='25,50',
        ...
        self.parser.add_argument('--best_ckpt_metric', type=str, default='val_AUROC', choices=('val_loss', 'val_AUROC'),
        ...
        self.parser.add_argument('--do_rotate', type=util.str_to_bool, default=True,
                                 help='If true, do random rotation (up to 30 degrees) of the scan during training.')
        self.parser.add_argument('--do_jitter', type=util.str_to_bool, default=True,
                                 help='If true, do random jittering along the depth dimension.')
        ...
        self.parser.add_argument('--hem_epoch_size', type=int, default=1000,
                                 help='Size of an epoch when using HEM.')
        self.parser.add_argument('--hem_norm_method', type=str, default='standard', choices=('standard', 'softmax'),
                                 help='Method for normalizing losses to compute probabilities in HardExampleMiner.')
        ...
        self.parser.add_argument('--fine_tuning_boundary', type=str, default='encoders.2',
